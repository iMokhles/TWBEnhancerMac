...
- (void)postMediaUpload:(NSURL *)mediaURL
    uploadProgressBlock:(void(^)(NSInteger bytesWritten, NSInteger totalBytesWritten, NSInteger totalBytesExpectedToWrite))uploadProgressBlock
           successBlock:(void(^)(NSDictionary *imageDictionary, NSString *mediaID, NSString *size, NSArray *allKeys))successBlock
             errorBlock:(void(^)(NSError *error))errorBlock {
...
- (void)postMediaUploadData:(NSData *)data
 ...
 downloadProgressBlock:nil
          successBlock:^(NSDictionary *rateLimits, id response) {
              ...
              successBlock(imageDictionary, mediaID, size, allKeys);
          }
            errorBlock:errorBlock];
}
